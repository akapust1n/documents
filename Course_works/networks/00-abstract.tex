...
\begin{center}
	...
	\hfill \break
	\large{Cистема телеметрии для графического редактора Крита}\\
	\hfill \break
	\hfill \break
	\hfill \break
	\hfill \break
	...
	\normalsize {
		...
		\makebox[\textwidth][c]{}%
		\makebox[0pt][r]{{$\underset{\text{(Подипсь, дата)}}{\underline{\hspace{8cm}}}$ \space Капустин А.И.}}
	}\\
	\hfill \break	
	\normalsize {
		\noindent
		...
		\makebox[\textwidth][c]{ ~~~~~~~~      }%
		\makebox[0pt][r]{{$\underset{\text{(Подпись, дата)}}{\underline{\hspace{6cm}}}$ \space Рогозин Н.О.}}
	}
	\hfill \break
	\hfill \break
	\hfill \break
